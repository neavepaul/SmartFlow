...
lightsNSL = TrafficLights(25, 8, 7, pin_factory=factory_NS)  # RYG
lightsSN = TrafficLights(25, 8, 7, pin_factory=factory_SN)  # RYG
lightsSNL = TrafficLights(25, 8, 7, pin_factory=factory_SN)  # RYG
lightsEW = TrafficLights(25, 8, 7, pin_factory=factory_EW)  # RYG
lightsEWL = TrafficLights(25, 8, 7, pin_factory=factory_EW)  # RYG
...
old_action = -1  # Initialize with an invalid action
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as pi_socket:
    ...
    try:
        while True:
            ...
            received_data = pi_socket.recv(1024)
            ...
            pi_socket.sendall(response.encode())
